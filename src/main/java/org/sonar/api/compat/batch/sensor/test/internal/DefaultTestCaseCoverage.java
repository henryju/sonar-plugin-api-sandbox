...
import org.sonar.api.compat.batch.sensor.test.TestCaseCoverageBuilder;

import java.util.Collections;
import java.util.List;

public class DefaultTestCaseCoverage extends DefaultStorable<TestCaseCoverage> implements TestCaseCoverage, TestCaseCoverageBuilder {
